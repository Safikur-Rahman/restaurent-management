      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card bg-primary">
            <div class="card-body">
              ...
              <p class="mb-0 text-muted text-sm">You made an extra <span class="text-white">35,000</span> this year
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card bg-info">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Total Costs</h6>
              <h4 class="mb-3">78,250 <span class="badge bg-light-success border border-success"><i
                    class="ti ti-trending-up"></i> 70.5%</span></h4>
              <p class="mb-0 text-muted text-sm">You made an extra <span class="text-white">8,900</span> this year</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card bg-success">
            <div class="card-body">
              ...
              <p class="mb-0 text-muted text-sm">You made an extra <span class="text-white">1,943</span> this year</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="card bg-warning">
            <div class="card-body">
              <h6 class="mb-2 f-w-400 text-muted">Total Monthly Sales</h6>
              <h4 class="mb-3">35,07800 <span class="badge bg-light-danger border border-danger"><i
                    class="ti ti-trending-down"></i> 27.4%</span></h4>
              <p class="mb-0 text-muted text-sm">You made an extra <span class="text-white">20,395</span> this year
              </p>
            </div>
          </div>
        </div>
